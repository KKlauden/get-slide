...
- **Pre-built reference candidates**:
  - **pitch** — YC / TechCrunch modern-tech style: single Cabinet Grotesk + 3-variant rotation (lite/dark/forest) + geometric decoration (M18 ambient frames / M20 pill highlight) + full chrome ring. **Fits**: standard 9-page pitch, product launch, brand deck
